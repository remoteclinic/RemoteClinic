...
<div id="container">
<div id="page">
	<h1 class="patients patient-color">pending reports</h1>
...
<div class="innertube">
	...
	<?php 
	$sql=mysql_query("select * from p_reports where signed_by='' order by last_update desc limit 100")or die(mysql_error());
